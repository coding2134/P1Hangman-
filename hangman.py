...
#def a function called pick_random_word():
    ...
    # variable called index = select random word form word.txt
...
#create a main module:
    ...
    #while loop that runs until number_of_guesses is less then one or letters_to_guess is greater than zero:
        #variable called guess = ask_for_next-letter() and turn into lower case
            ...
            #remove guess from letters-to_guess
            #add guess to correct-letters_guessed
        #else:
            #add guess to incorrect_lettes_guessed
        ...
        #if statement to check if numbers of guesses is greater than a value;
